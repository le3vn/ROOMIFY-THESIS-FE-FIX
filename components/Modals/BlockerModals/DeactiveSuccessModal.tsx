...
const DeactiveSuccessModal: React.FC<ConfirmationModalProps> = ({
  visible,
  onConfirm,
  isSuccess,
  onCancel
        ...
        <div className='h-full'>
          ...
          {isSuccess ? 
            <div className='flex flex-col items-center px-8'>
              ...
              <h4 className='text-center'>Your blocker has been updated.</h4>
            </div>
            : 
...
export default DeactiveSuccessModal;
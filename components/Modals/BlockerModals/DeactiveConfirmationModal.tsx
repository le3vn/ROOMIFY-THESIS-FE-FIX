...
const DeactiveConfirmationModal: React.FC<ConfirmationModalProps> = ({
  visible,
  onConfirm,
  onCancel,
}) => {
        ...
        <div className='h-full'>
          <div className='h-2/3 flex flex-col justify-end'>
            <div className='flex flex-col items-center'>
              <h1 className='text-2xl font-bold'>Deactive Blocker ?</h1>
              <h4 className='text-center'>Make sure to choose the right blocker :)</h4>
            </div>
          </div>
...
export default DeactiveConfirmationModal;
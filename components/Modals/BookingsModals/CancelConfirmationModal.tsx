        ...
        <div className='h-full'>
          <div className='h-2/3 flex flex-col justify-end'>
            <div className='flex flex-col items-center'>
              ...
              <h4 className='text-center'>Approvals you get for this booking (if any) will be annulled !</h4>
            </div>
          </div>
          <div className='h-1/3 flex items-center justify-center'>
            <div className='flex gap-4'>
              <button className='bg-red-600 h-[50px] w-[150px] rounded-full text-white text-lg font-semibold' onClick={onConfirm}>Yes</button>

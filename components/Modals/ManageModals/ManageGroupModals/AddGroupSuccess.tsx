...
const AddGroupSuccessModal: React.FC<SuccessModalProps> = ({ visible, onConfirm, isSuccess }) => {
  return (
            ...
            {isSuccess ? (
              <div className="flex flex-col items-center px-8">
                ...
                <h4 className="text-center">
                  Your group has been successfully added. Check the management page for more details!
                </h4>
              </div>
            ) : (

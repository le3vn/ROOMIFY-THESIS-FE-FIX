...
const ApproveSuccessModal: React.FC<SuccessModalProps> = ({ isOpen, onClose }) => {
            ...
            <div className='h-full'>
              <div className='h-2/3 flex flex-col justify-end'>
                <div className='flex flex-col items-center px-8'>
                  <h1 className='text-2xl font-bold'>This booking is approved</h1>
                  <h4 className='text-center'>Check menu history for your approvals history :)</h4>
                </div>
              </div>

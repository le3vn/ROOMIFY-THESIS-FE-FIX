...
const ApproveModal: React.FC<ApproveModalProps> = ({ isOpen, onApprove, onClose }) => {
            ...
            <div className='h-full'>
              <div className='h-2/3 flex flex-col justify-end'>
                <div className='flex flex-col items-center'>
                  <h1 className='text-2xl font-bold'>Approve Booking ?</h1>
                  <h4 className='text-center'>Make sure to check the booking details carefully :)</h4>
                </div>
              </div>
              <div className='h-1/3 flex items-center justify-center'>
                <div className='flex gap-4'>
                  <button className='bg-purple-950 h-[50px] w-[150px] rounded-full text-white text-lg font-semibold' onClick={onApprove}>Approve</button>
                  <button className='bg-gray-200 h-[50px] w-[150px] rounded-full text-black text-lg font-semibold' onClick={onClose}>Cancel</button>
                </div>
              </div>
            </div>
          </div>
